                ...
                <Row>
                    ...
                    <div className='content' data-aos="fade-right" data-aos-duration="2000">
                            ...
                            <div className='contact-container rounded' data-aos="fade-down-right" data-aos-duration="3000">
                                ...
                                <ul>
                                    <li><a><i class="bi bi-telephone"></i> <div>(414) 857 - 0107</div></a></li>
                                    <li><a><i class="bi bi-envelope"></i> <div>happytummy@restaurant.com</div></a></li>
                                    <li><a><i class="bi bi-geo-alt"></i> <div>837 W. Marshall Lane Marshalltown, IA 50158, Los Angeles</div></a></li>
                                </ul>
                            </div>
                    </div>
                    </Col>
